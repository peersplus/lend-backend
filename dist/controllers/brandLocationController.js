...
export async function listBrandsWithLocationsController(req, res) {
    try {
        const filters = {};
        if (req.query.orgId)
...
export async function updateBrandBusinessUnitController(req, res) {
    try {
        const data = await brandLocationService.updateBrandBusinessUnit(req.params.id, req.body.businessUnitId ?? null);
        if (!data)
...
export async function listBrandLocationsController(req, res) {
    try {
        const filters = {};
        if (req.query.orgId)
            filters.orgId = req.query.orgId;
...
export async function linkBrandLocationController(req, res) {
    try {
...
export async function unlinkBrandLocationController(req, res) {
    try {
