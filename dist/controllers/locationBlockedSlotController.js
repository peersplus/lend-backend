import { cancelConflictingBookings, createBlockedSlot, deleteBlockedSlot, getBlockedSlotById, listBlockedSlots, } from '../services/locationBlockedSlotService.js';
...
export async function getBlockedSlotController(req, res) {
    try {
...
export async function cancelConflictingBookingsController(req, res) {
    try {
        if (!req.authUser?.uid) {
            res.status(401).json({ data: null, error: { message: 'Unauthorized' } });
            return;
