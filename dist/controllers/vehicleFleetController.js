...
export async function fleetOverviewController(req, res) {
    try {
...
export async function vehicleAvailabilityController(req, res) {
    try {
...
export async function listTransitsController(req, res) {
    try {
        const filters = {};
        if (req.query.vehicle_id)
            filters.vehicle_id = String(req.query.vehicle_id);
        if (req.query.status)
            filters.status = String(req.query.status);
        if (req.query.from_date)
            filters.from_date = String(req.query.from_date);
        if (req.query.to_date)
            filters.to_date = String(req.query.to_date);
        if (req.query.to_location_id)
            filters.to_location_id = String(req.query.to_location_id);
        if (req.query.receiver_profile_id)
            filters.receiver_profile_id = String(req.query.receiver_profile_id);
...
export async function createTransitController(req, res) {
    try {
...
export async function dispatchTransitController(req, res) {
    try {
...
export async function arriveTransitController(req, res) {
    try {
...
export async function cancelTransitController(req, res) {
    try {
...
export async function locationSecurityController(req, res) {
    try {
...
export async function assignReceiverController(req, res) {
    try {
 ...
 */
export async function receiveVehicleController(req, res) {
    try {
...
export async function incomingTransitsController(req, res) {
    try {
 ...
 */
export async function createTransitRequestController(req, res) {
    try {
 ...
 */
export async function listTransitRequestsController(req, res) {
    try {
        const filters = {};
        if (req.query.from_location_id)
            filters.from_location_id = String(req.query.from_location_id);
        if (req.query.to_location_id)
            filters.to_location_id = String(req.query.to_location_id);
        if (req.query.requested_by_profile_id)
            filters.requested_by_profile_id = String(req.query.requested_by_profile_id);
        if (req.query.status)
            filters.status = String(req.query.status);
        if (req.query.dealer_id)
            filters.dealer_id = String(req.query.dealer_id);
 ...
 */
export async function approveTransitRequestController(req, res) {
    try {
 ...
 */
export async function rejectTransitRequestController(req, res) {
    try {
        const { manager_profile_id, notes } = req.body || {};
 ...
 */
export async function cancelTransitRequestController(req, res) {
    try {
