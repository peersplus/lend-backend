...
const FollowUpReminderConfigSchema = new Schema({
...
export const FollowUpReminderConfig = mongoose.models['FollowUpReminderConfig'] ||
    mongoose.model('FollowUpReminderConfig', FollowUpReminderConfigSchema);
